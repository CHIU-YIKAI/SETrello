...
import {AddTrelloComponent} from "./add-Trello/add-trello.component";
...
const routes: Routes = [
  ...
  {path: 'addTrello', component: AddTrelloComponent},
  {path: 'trelloBoard', component: TrelloBoardComponent},
